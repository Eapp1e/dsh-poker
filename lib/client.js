...
window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    const css = [
      ...
      '.dshp-set{display:flex;flex-direction:column;gap:10px;max-width:560px}',
    ...
    function CoachWindow(props) {
      ...
      return React.createElement(
        ...
        React.createElement(
          ...
          React.createElement('span', { className: 'dshp-coachWinTitle' }, '\u{1F393} \u6559\u7ec3'),
          coach.equity
    ...
    function stepDelay(step, previousStreet, cap) {
      ...
      if (step.deal) {
        ...
        return Math.max(200, Math.min(step.dealFirst ? DEAL_MS : DEAL_CARD_MS, cap));
      }
      ...
      return Math.max(240, Math.min(base, cap));
    }
    ...
    function Actions(props) {
      ...
      // the sizing helper explains itself.
      ...
      const adviceLine = advice && advised !== null
        ? React.createElement(
            'div',
            {
            ...
            React.createElement('span', { className: 'dshp-adviceLabel' }, '\u{1F393} \u6559\u7ec3\u5efa\u8bae'),
     ...
     * The plugin's page in the settings dialog.
     *
     * Reads and writes the host's own settings route, so the values live in the host
     * user-settings document (not in the browser): the AI seats keep their endpoint
     * across restarts and across conversations. The API key is never sent back to
     * the page - the host reports only whether one is stored.
     */
    function PokerSettings() {
      ...
      React.useEffect(() => {
        ...
        fetch('/poker/settings')
          .then((response) => response.json())
          .then((answer) => { if (live && answer && answer.ok) setForm(answer.settings); })
      ...
      const field = (label, hint, node) => React.createElement('label', { className: 'dshp-setRow' },
        React.createElement('span', { className: 'dshp-setLabel' }, label),
        node,
        hint ? React.createElement('span', { className: 'dshp-setHint' }, hint) : null,
      );
      const text = (key, type, extra) => React.createElement('input', Object.assign({
        className: 'dshp-setInput',
        type,
        value: form[key],
        onChange: (event) => patch(key, type === 'number' ? Number(event.target.value) : event.target.value),
      }, extra || {}));
      return React.createElement('div', { className: 'dshp-set' },
        React.createElement('h3', { className: 'dshp-setTitle' }, '\u5fb7\u5dde\u6251\u514b\uff1aAI \u5bf9\u624b'),
        React.createElement('p', { className: 'dshp-setHint' },
          '\u628a\u90e8\u5206\u673a\u5668\u4eba\u4ea4\u7ed9\u4efb\u610f OpenAI \u517c\u5bb9\u63a5\u53e3\uff08/v1/chat/completions\uff09\u3002'
          + '\u63a5\u53e3\u8d85\u65f6\u3001\u79bb\u7ebf\u6216\u8fd4\u56de\u4e0d\u4e86\u89e3\u7684\u52a8\u4f5c\u65f6\uff0c\u8be5\u5e2d\u4f4d\u81ea\u52a8\u9000\u56de\u5185\u7f6e\u7b56\u7565\u3002'),
        field('\u542f\u7528 AI \u5bf9\u624b', form.enabled ? '\u5df2\u542f\u7528' : '\u5173\u95ed\u65f6\u5168\u90e8\u4f7f\u7528\u5185\u7f6e\u7b56\u7565',
          React.createElement('input', {
        ...
        field('AI \u5e2d\u4f4d\u6570', '\u4ece 1 \u53f7\u5e2d\u5f00\u59cb\u63a5\u7ba1\u7684\u673a\u5668\u4eba\u6570\u91cf', text('seats', 'number', { min: 0, max: 8 })),
        field('Base URL', '\u4f8b\u5982 https://api.openai.com/v1\uff08\u4e0d\u5e26 /chat/completions\uff09', text('baseUrl', 'text')),
        field('API Key', form.hasApiKey ? '\u5df2\u4fdd\u5b58\u4e00\u4e2a\u5bc6\u94a5\uff0c\u7559\u7a7a\u5219\u4e0d\u4fee\u6539' : '\u4ec5\u5b58\u5728\u672c\u673a\u7684\u7528\u6237\u914d\u7f6e\u91cc',
          React.createElement('input', {
            className: 'dshp-setInput',
            type: 'password',
            value: keyDraft,
        ...
        field('\u6a21\u578b', '\u63a5\u53e3\u7aef\u63a5\u53d7\u7684\u6a21\u578b\u540d', text('model', 'text')),
        field('\u6e29\u5ea6', '0 = \u7a33\u5b9a\uff0c1 \u4ee5\u4e0a = \u968f\u673a', text('temperature', 'number', { step: 0.1, min: 0, max: 2 })),
        field('\u8d85\u65f6\uff08\u6beb\u79d2\uff09', '\u8d85\u65f6\u540e\u8be5\u5e2d\u4f4d\u6539\u7528\u5185\u7f6e\u7b56\u7565', text('timeoutMs', 'number', { min: 500, max: 60000, step: 500 })),
        field('JSON \u6a21\u5f0f', '\u63a5\u53e3\u652f\u6301 response_format \u65f6\u6253\u5f00',
          React.createElement('input', {
            className: 'dshp-setCheck',
            type: 'checkbox',
            checked: form.jsonMode === true,
