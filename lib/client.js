...
window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    const css = [
      ...
      '.dshp-advice{display:flex;align-items:center;gap:6px;font-size:11px;padding:3px 8px;border-radius:8px;background:var(--dsw-alias-fill-l2,rgba(127,127,127,.14));border:1px solid var(--dsw-alias-state-warn-primary,rgba(255,209,102,.5));color:var(--dsw-alias-label-primary,inherit);overflow:hidden}',
      '.dshp-adviceText{font-weight:600;overflow:hidden;text-overflow:ellipsis;white-space:nowrap}',
    ...
    function Actions(props) {
      ...
      const adviceLine = advice && advised !== null
        ? React.createElement(
            ...
            React.createElement('span', null, '\u{1F393} \u6559\u7ec3\u5efa\u8bae'),
